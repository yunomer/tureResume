...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          Ture saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Ture apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Ture, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Ture
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Ture is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Ture intentionally only offers
  ...
  {
    question: "Q3. Who created Ture and why?",
    answer: (
      <p>
        Ture was created by{" "}
        <Link href="https://github.com/yunomer">Omer Ashfaq</Link> and designed
        ...
        that led to Ture, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Ture can help
  ...
  {
    question: "Q4. How can I support Ture?",
    answer: (
      <>
        <p>
          The best way to support Ture is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:hello@ture.ai">hello@ture.ai</Link>{" "}
          or{" "}
          <Link href="https://github.com/yunomer/tureResume/issues/new">
            open an issue
          </Link>{" "}
        ...
        <p>
          Another great way to support Ture is by spreading the words.
          ...
          by{" "}
          <Link href="https://github.com/yunomer/tureResume">
